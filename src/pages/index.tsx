    ...
    return (
        <div className={styles.container}>
            <div className={styles.greetings}>
                <h2>Treinador(a)! Sou sua pokedex e estou aqui para ajudar, insira o Pokémon desejado e tecle enter.</h2>
                <a href="https://bulbapedia.bulbagarden.net/wiki/List_of_Pok%C3%A9mon_by_National_Pok%C3%A9dex_number">Está na dúvida? Clique aqui 👈.</a>
                <input 
